    ...
    return {
        ...
        operators: {
            ...
            proximity: {
                ...
                options: {
                    ...
                    optionLabel: formatMessage(MESSAGES.proximityOptionsLabel),
        ...
        widgets: {
            ...
            textarea: {
                ...
                valuePlaceholder: formatMessage(MESSAGES.textareaPlaceholder),
            },
            number: {
            ...
            date: {
                ...
                valueLabels: [
                    ...
                    },
                    {
                        ...
                        placeholder: formatMessage(MESSAGES.dateToPlaceholder),
                    },
                ],
            },
            time: {
                ...
                valueLabels: [
                    ...
                    },
                    {
                        ...
                        placeholder: formatMessage(MESSAGES.timeToPlaceholder),
                    },
                ],
            },
            datetime: {
                ...
                valuePlaceholder: formatMessage(MESSAGES.datetimePlaceholder),
                valueLabels: [
                    {
