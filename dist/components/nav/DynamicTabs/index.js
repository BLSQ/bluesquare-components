...
var DynamicTabs = /*#__PURE__*/function (_Component) {
  (0, _inherits2["default"])(DynamicTabs, _Component);
  ...
  function DynamicTabs(props) {
    ...
    (0, _classCallCheck2["default"])(this, DynamicTabs);
  ...
  (0, _createClass2["default"])(DynamicTabs, [{
    key: "handleAddTab",
    ...
    value: function setTabsElement(element, index) {
      ...
      if (newWidth !== tabsWidth[index]) {
        var newArray = (0, _toConsumableArray2["default"])(tabsWidth);
