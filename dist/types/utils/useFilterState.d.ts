...
export declare const useFilterState: ({ baseUrl, params, searchActive, withPagination, saveSearchInHistory, searchAlwaysEnabled, withPathParams, }: FilterStateParams) => FilterState;
