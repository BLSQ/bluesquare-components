...
/* harmony export */   "renderTags": () => (/* binding */ defaultRenderTags)
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/defineProperty */ "@babel/runtime/helpers/defineProperty");
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/helpers/extends */ "@babel/runtime/helpers/extends");
...
/* harmony import */ var _messages__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./messages */ "./src/components/inputs/Select/messages.js");
/* harmony import */ var _styles__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../styles */ "./src/components/inputs/styles.js");
/* harmony import */ var _utils_useKeyPressListener__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../../utils/useKeyPressListener */ "./src/utils/useKeyPressListener.js");
...
const defaultRenderTags = getLabel => (tagValue, getTagProps) => tagValue.map((option, index) => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement((_material_ui_core_Chip__WEBPACK_IMPORTED_MODULE_6___default()), _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_1___default()({
  color: "secondary",
  style: {
...
const SelectCustom = ({
  ...
  const intl = (0,_utils_useSafeIntl__WEBPACK_IMPORTED_MODULE_10__.useSafeIntl)();
  const classes = (0,_styles__WEBPACK_IMPORTED_MODULE_12__.useStyles)();
  const shiftKeyIsDown = (0,_utils_useKeyPressListener__WEBPACK_IMPORTED_MODULE_13__.useKeyPressListener)('Shift');

  const getOption = optionValue => options.find(o => `${o.value}` === `${optionValue}`);

  const fixedValue = (0,react__WEBPACK_IMPORTED_MODULE_2__.useMemo)(() => {
    if (value) {
      if (multi) {
  ...
  const handleChange = (0,react__WEBPACK_IMPORTED_MODULE_2__.useCallback)((e, newValue) => {
  ...
  const extraProps = {
    getOptionLabel: getOptionLabel || (option => (option === null || option === void 0 ? void 0 : option.label) ?? option),
  ...
  const renderInput = params => {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement((_material_ui_core_TextField__WEBPACK_IMPORTED_MODULE_4___default()), _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_1___default()({}, paramsCopy, {
      variant: "outlined",
      disabled: disabled,
      ...
      InputProps: _objectSpread(_objectSpread({}, params.InputProps), {}, {
        endAdornment: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement((react__WEBPACK_IMPORTED_MODULE_2___default().Fragment), null, loading ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_8__.CircularProgress, {
          color: "inherit",
          size: 20
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement((_material_ui_core_Box__WEBPACK_IMPORTED_MODULE_5___default()), {
    mt: 1,
    mb: 2
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement((_material_ui_lab_Autocomplete__WEBPACK_IMPORTED_MODULE_7___default()), _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_1___default()({
    disabled: disabled,
    ...
    onChange: handleChange,
    loading: loading,
    closeIcon: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement((_material_ui_icons_Clear__WEBPACK_IMPORTED_MODULE_9___default()), null),
...
SelectCustom.defaultProps = {
  ...
  getOptionLabel: null,
  renderOption: null,
  noOptionsText: _messages__WEBPACK_IMPORTED_MODULE_11__.MESSAGES.noOptions,
  helperText: undefined,
  renderTags: defaultRenderTags(o => o !== null && o !== void 0 && o.label ? o.label : ''),
  returnFullObject: false // use this one if you pass array of objects as options and want an array of objects as sected items, not a string of id's

};
SelectCustom.propTypes = {
  errors: prop_types__WEBPACK_IMPORTED_MODULE_3___default().arrayOf((prop_types__WEBPACK_IMPORTED_MODULE_3___default().string)),
  keyValue: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().string.isRequired),
  ...
  noOptionsText: prop_types__WEBPACK_IMPORTED_MODULE_3___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_3___default().object), (prop_types__WEBPACK_IMPORTED_MODULE_3___default().string)]),
  ...
  options: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().array),
  touched: prop_types__WEBPACK_IMPORTED_MODULE_3___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_3___default().bool), (prop_types__WEBPACK_IMPORTED_MODULE_3___default().array)]),
  ...
  getOptionLabel: prop_types__WEBPACK_IMPORTED_MODULE_3___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_3___default().object), (prop_types__WEBPACK_IMPORTED_MODULE_3___default().func)]),
  getOptionSelected: prop_types__WEBPACK_IMPORTED_MODULE_3___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_3___default().object), (prop_types__WEBPACK_IMPORTED_MODULE_3___default().func)]),
  ...
  returnFullObject: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().bool)
};
...
/* harmony export */   "LoadingSpinner": () => (/* reexport safe */ _components_LoadingSpinner_index_tsx__WEBPACK_IMPORTED_MODULE_0__.LoadingSpinner),
...
/* harmony export */   "addPositionIndex": () => (/* reexport safe */ _utils__WEBPACK_IMPORTED_MODULE_58__.addPositionIndex),
/* harmony export */   "capitalize": () => (/* reexport safe */ _utils__WEBPACK_IMPORTED_MODULE_58__.capitalize),
/* harmony export */   "clone": () => (/* reexport safe */ _utils__WEBPACK_IMPORTED_MODULE_58__.clone),
/* harmony export */   "commonStyles": () => (/* reexport safe */ _styles_iaso_common__WEBPACK_IMPORTED_MODULE_19__.commonStyles),
/* harmony export */   "createUrl": () => (/* reexport safe */ _utils_fetchData__WEBPACK_IMPORTED_MODULE_61__.createUrl),
/* harmony export */   "deepEqual": () => (/* reexport safe */ _utils__WEBPACK_IMPORTED_MODULE_58__.deepEqual),
/* harmony export */   "defaultSelectionActions": () => (/* reexport safe */ _utils_tableUtils__WEBPACK_IMPORTED_MODULE_60__.defaultSelectionActions),
/* harmony export */   "displayDateFromTimestamp": () => (/* reexport safe */ _utils_intlUtils__WEBPACK_IMPORTED_MODULE_59__.displayDateFromTimestamp),
/* harmony export */   "english": () => (/* reexport safe */ _locale__WEBPACK_IMPORTED_MODULE_57__.english),
/* harmony export */   "formatThousand": () => (/* reexport safe */ _utils__WEBPACK_IMPORTED_MODULE_58__.formatThousand),
/* harmony export */   "french": () => (/* reexport safe */ _locale__WEBPACK_IMPORTED_MODULE_57__.french),
/* harmony export */   "getColumnsHeadersInfos": () => (/* reexport safe */ _utils_tableUtils__WEBPACK_IMPORTED_MODULE_60__.getColumnsHeadersInfos),
/* harmony export */   "getOrderArray": () => (/* reexport safe */ _utils_tableUtils__WEBPACK_IMPORTED_MODULE_60__.getOrderArray),
/* harmony export */   "getParamsKey": () => (/* reexport safe */ _utils_tableUtils__WEBPACK_IMPORTED_MODULE_60__.getParamsKey),
/* harmony export */   "getSimplifiedColumns": () => (/* reexport safe */ _utils_tableUtils__WEBPACK_IMPORTED_MODULE_60__.getSimplifiedColumns),
/* harmony export */   "getSort": () => (/* reexport safe */ _utils_tableUtils__WEBPACK_IMPORTED_MODULE_60__.getSort),
/* harmony export */   "getTableParams": () => (/* reexport safe */ _utils_tableUtils__WEBPACK_IMPORTED_MODULE_60__.getTableParams),
/* harmony export */   "getTableUrl": () => (/* reexport safe */ _utils_tableUtils__WEBPACK_IMPORTED_MODULE_60__.getTableUrl),
...
/* harmony export */   "removePositionIndex": () => (/* reexport safe */ _utils__WEBPACK_IMPORTED_MODULE_58__.removePositionIndex),
/* harmony export */   "renderTags": () => (/* reexport safe */ _components_inputs_Select__WEBPACK_IMPORTED_MODULE_33__.renderTags),
/* harmony export */   "selectionInitialState": () => (/* reexport safe */ _utils_tableUtils__WEBPACK_IMPORTED_MODULE_60__.selectionInitialState),
/* harmony export */   "setTableSelection": () => (/* reexport safe */ _utils_tableUtils__WEBPACK_IMPORTED_MODULE_60__.setTableSelection),
/* harmony export */   "substituteVars": () => (/* reexport safe */ _utils__WEBPACK_IMPORTED_MODULE_58__.substituteVars),
/* harmony export */   "tableInitialResult": () => (/* reexport safe */ _utils_tableUtils__WEBPACK_IMPORTED_MODULE_60__.tableInitialResult),
/* harmony export */   "testTS": () => (/* reexport safe */ _utils_test_ts__WEBPACK_IMPORTED_MODULE_18__.testTS),
...
/* harmony export */   "translateOptions": () => (/* reexport safe */ _utils_intlUtils__WEBPACK_IMPORTED_MODULE_59__.translateOptions),
/* harmony export */   "truncateText": () => (/* reexport safe */ _utils__WEBPACK_IMPORTED_MODULE_58__.truncateText),
...
/* harmony export */   "useTranslatedOptions": () => (/* reexport safe */ _utils_intlUtils__WEBPACK_IMPORTED_MODULE_59__.useTranslatedOptions),
/* harmony export */   "withLink": () => (/* reexport safe */ _components_LinkProvider__WEBPACK_IMPORTED_MODULE_45__.withLink)
/* harmony export */ });
/* harmony import */ var _components_LoadingSpinner_index_tsx__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/LoadingSpinner/index.tsx */ "./src/components/LoadingSpinner/index.tsx");
...
/* harmony import */ var _utils_test_ts__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./utils/test.ts */ "./src/utils/test.ts");
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_58__ = __webpack_require__(/*! ./utils */ "./src/utils/index.js");
/* harmony import */ var _utils_intlUtils__WEBPACK_IMPORTED_MODULE_59__ = __webpack_require__(/*! ./utils/intlUtils */ "./src/utils/intlUtils.js");
/* harmony import */ var _utils_tableUtils__WEBPACK_IMPORTED_MODULE_60__ = __webpack_require__(/*! ./utils/tableUtils */ "./src/utils/tableUtils.js");
/* harmony import */ var _utils_fetchData__WEBPACK_IMPORTED_MODULE_61__ = __webpack_require__(/*! ./utils/fetchData */ "./src/utils/fetchData.js");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "LoadingSpinner": () => (/* binding */ styledSpinner)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
...
const styles = () => ({
    rootFixed: Object.assign(Object.assign({}, baseRoot), { position: 'fixed', zIndex: '10000' }),
...
const LoadingSpinner = props => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: {
            padding,
        }, className: classnames__WEBPACK_IMPORTED_MODULE_4___default()(fixed && !absolute && classes.rootFixed, absolute && classes.rootAbsolute, !fixed && !absolute && classes.root, transparent && classes.rootTransparent) },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement((_material_ui_core_CircularProgress__WEBPACK_IMPORTED_MODULE_1___default()), { size: size })));
};
...
const styledSpinner = (0,_material_ui_core__WEBPACK_IMPORTED_MODULE_2__.withStyles)(styles)(LoadingSpinner);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "testTS": () => (/* binding */ testTS)
/* harmony export */ });
